...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        x = self.block(x)
        return x
'''BasicBlock Structure is the result of discussion with b08502059 楊昇瞱.'''
...
hidden_dim = 2560               # the hidden dim
...
optimizer = torch.optim.AdamW(model.parameters(), lr=learning_rate, betas=(0.9, 0.999), weight_decay=1e-4, amsgrad=True)
