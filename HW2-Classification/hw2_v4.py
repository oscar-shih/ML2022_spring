...
optimizer = torch.optim.AdamW(model.parameters(), lr=learning_rate, betas=(0.9, 0.999), weight_decay=3e-4, amsgrad=True)
...
for epoch in range(num_epoch):
    ...
    print('train with lr=', learning_rate)
    # validation
    if len(val_set) > 0:
